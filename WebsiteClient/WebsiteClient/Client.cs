...
namespace WebsiteClient
{
    class Client
    {
        ...
        static void Main(string[] args)
        {
            ...
            var loginData = Encoding.UTF8.GetBytes("email=stephen_c_adams@yahoo.co.nz&password=!s9c5a8*&commit=submit&authenticity_token=hIldFpaRhvp4aQkNEXaCOz3kcl3FsVHi1iJ3pU1nQ+U=&utf8=&#x2713;");
